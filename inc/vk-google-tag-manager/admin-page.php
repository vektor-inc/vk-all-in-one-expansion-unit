...
<h3><?php esc_html_e( 'Google Tag Manager Setting', 'vk-all-in-one-expansion-unit' ); ?></h3>
<table class="form-table">
<!-- Google Analytics -->
<tr>
	<th><?php esc_html_e( 'Google tag manager ID', 'vk-all-in-one-expansion-unit' ); ?></th>
	<td>
		<p><?php esc_html_e( 'Please enter the Google Tag Manager ID to use on this site.', 'vk-all-in-one-expansion-unit' ); ?></p>
