...
<table class="form-table">
    <!-- Favicon -->
    <tr>
    <th><label for="vkExUnit_cta_settings"><?php _e('CTA Setting', 'vkExUnit'); ?></label></th>
        <td>
<ul>
        ...
        ?>
<dl>
<dt><label ><?php echo $type; ?></label></dt>
<dd><select name="vkExUnit_cta_settings[types][<?php echo $type; ?>]" id="vkExUnit_cta_settings">
    <?php foreach($ctas as $cta): ?>
...
<?php
    ...
    public function render_responce($id=null){
        $arg = array(
            'posttype' => self::$posttype_name,
        );
