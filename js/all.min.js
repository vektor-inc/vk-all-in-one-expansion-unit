...
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');jQuery(function(){jQuery('.prArea > .subSection-title').flatHeights();jQuery('.prArea > .summary').flatHeights();jQuery('.childPage_list_box').flatHeights();jQuery('.childPage_list_title').flatHeights();jQuery('.childPage_list_body').flatHeights();});