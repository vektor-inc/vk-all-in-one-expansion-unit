...
class Vk_Admin {
	...
	public static function get_news_body() {
		...
		if ( 'ja' == get_locale() ) {
			$exUnit_feed_url = apply_filters( 'vkAdmin_news_RSS_URL_ja', 'http://ex-unit.nagoya/ja/feed' );
		} else {
			$exUnit_feed_url = apply_filters( 'vkAdmin_news_RSS_URL', 'http://ex-unit.nagoya/feed' );
		}
