...
[ Bug Fix ] Fixed the Share Button, HTML Sitemap, Page List from Ancestor, Child Page List, Contact Section and Call to Action blocks showing "This block has encountered an error and cannot be previewed" in the editor when the page contains a cross-origin iframe embed (e.g. YouTube, X).
