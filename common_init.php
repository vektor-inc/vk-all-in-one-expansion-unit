...
add_filter('vkExUnit_common_options_validate', 'vkExUnit_content_filter_state_save_change');
function vkExUnit_content_filter_state_save_change($output){
	$output['content_filter_state'] = 'content';
	return $output;
}