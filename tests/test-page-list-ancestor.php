...
class PageListAncestorTest extends WP_UnitTestCase {
    ...
    public function test_block() {
        ...
        $test_array = array(
            'class-empty' => array( 
                'attr'    => array(),
                'correct' => '<section class="veu_pageList_ancestor veu_card veu_childPageIndex_block"><div class="veu_card_inner"><h3 class="pageList_ancestor_title veu_card_title"><a href="' . home_url() . '/?page_id=' . $first . '">First Page</a></h3><ul class="pageList"><li class="page_item page-item-' . $second . ' page_item_has_children current_page_ancestor current_page_parent"><a href="' . home_url() . '/?page_id=' . $second . '">Second Page</a><ul class="children"><li class="page_item page-item-' . $third . ' current_page_item"><a href="' . home_url() . '/?page_id=' . $third . '" aria-current="page">Third Page</a></li></ul></li></ul></div></section>'
            ),
            'class=""' => array( 
                'attr'    => array(
                    'className' => '',
            ...
            'class="aaa"' => array( 
                ...
                'correct' => '<section class="veu_pageList_ancestor veu_card veu_childPageIndex_block aaa"><div class="veu_card_inner"><h3 class="pageList_ancestor_title veu_card_title"><a href="' . home_url() . '/?page_id=' . $first . '">First Page</a></h3><ul class="pageList"><li class="page_item page-item-' . $second . ' page_item_has_children current_page_ancestor current_page_parent"><a href="' . home_url() . '/?page_id=' . $second . '">Second Page</a><ul class="children"><li class="page_item page-item-' . $third . ' current_page_item"><a href="' . home_url() . '/?page_id=' . $third . '" aria-current="page">Third Page</a></li></ul></li></ul></div></section>'
            ),
            'class="" onmouseover="alert(/XSS/)" style="background:red;""' => array( 
                'attr'    => array(
                    'className' => '" onmouseover="alert(/XSS/)" style="background:red;"',
                ),
                'correct' => '<section class="veu_pageList_ancestor veu_card veu_childPageIndex_block &quot; onmouseover=&quot;alert(/XSS/)&quot; style=&quot;background:red;&quot;"><div class="veu_card_inner"><h3 class="pageList_ancestor_title veu_card_title"><a href="' . home_url() . '/?page_id=' . $first . '">First Page</a></h3><ul class="pageList"><li class="page_item page-item-' . $second . ' page_item_has_children current_page_ancestor current_page_parent"><a href="' . home_url() . '/?page_id=' . $second . '">Second Page</a><ul class="children"><li class="page_item page-item-' . $third . ' current_page_item"><a href="' . home_url() . '/?page_id=' . $third . '" aria-current="page">Third Page</a></li></ul></li></ul></div></section>'
            ),
            'class="" onmouseover="alert(/XSS/)" style="background:red;" ' => array( 
                'attr'    => array(
                    'className' => '" onmouseover="alert(/XSS/)" style="background:red;" ',
